      ...
      <div class="w_450 m_15 p_r f_0">
        <div :class="[scoreBackClass, 'pointer', 'p_3']">
          <form action="#" method="get" accept-charset="utf-8">
            <img :src="diffImage" class="h_24 f_l">
            ...
            <div class="black_block t_l f_13 break">
              <table class="collapse f_11 ">
                <tbody><tr>
                  <td>上次进行游戏的日期：</td>
                  <td>{{lastPlayDate}}</td>
                </tr>
            ...
            <div class="score_icons_container">
              ...
              <div v-if="dx_score" class="music_score_block w_150 t_r f_12">
                ...
                {{ dx_score }}
                <img :src="getDxStarImage(dx_score)" class="h">
              </div>
            </div>
...
const getDxStarImage = (dxScore: string) => {
  ...
  if (percentage >= 97) {
    return '/src/assets/music/music_icon_dxstar_detail_5.png'
  }
  if (percentage >= 95) {
    return '/src/assets/music/music_icon_dxstar_detail_4.png'
  }
  if (percentage >= 93) {
    return '/src/assets/music/music_icon_dxstar_detail_3.png'
  }
  if (percentage >= 90) {
    return '/src/assets/music/music_icon_dxstar_detail_2.png'
  }
  if (percentage >= 85) {
    return '/src/assets/music/music_icon_dxstar_detail_1.png'
  }
